export const mockData = {
  ...
  recentTransactions: [
    ...
    { id: 2, name: 'Salary', date: '2024-07-25', amount: 4500.00 },
    { id: 3, name: 'Groceries', date: '2024-07-23', amount: -75.43 },
    { id: 4, name: 'Rent', date: '2024-07-22', amount: -1100.00 },
    { id: 5, name: 'Freelance Gig', date: '2024-07-20', amount: 350.00 },
  ],
  spendingByCategory: [
    { category: 'Rent', amount: 1100.00 },
